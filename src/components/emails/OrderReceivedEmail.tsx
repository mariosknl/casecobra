...
const OrderReceivedEmail = ({
  ...
  orderId,
  orderDate
}: { shippingAddress: ShippingAddress, orderId: string, orderDate: string }) => {
  const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://casecobra-mocha.vercel.app'
  return (
    <Html>
      <Head />
      <Preview>Your order summary and estimated delivery data</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={{ ...global.text, marginTop: 24 }}>If you have questions regarding your order, please feel free to contact us with your order number and we're here to help.</Text>
          </Section>
          <Hr style={global.hr} />
