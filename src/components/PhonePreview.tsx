  ...
  return (
    <AspectRatio ref={ref} ratio={3000 / 2001} className='relative'>
      <div className="absolute z-20 scale-[1.0352]" style={{
        ...
        <img width={renderedDimensions.width / (3000 / 637)} className={cn("phone-skew relative z-20 rounded-t-[15px] rounded-b-[10px] md:rounded-t-[30px] md:rounded-b-[20px]", caseBackgroundColor)} alt='phone' src={croppedImageUrl} />
      </div>
